...
export default class ImageMarkup extends LightningElement {
    ...
    saveImage() {
        ...
        combinedCanvas.width = this.imageCanvas.width;
        combinedCanvas.height = this.imageCanvas.height;
        const combinedCtx = combinedCanvas.getContext('2d');
        
        combinedCtx.drawImage(this.imageCanvas, 0, 0);
        combinedCtx.drawImage(this.markupCanvas, 0, 0);
        
        combinedCanvas.toBlob(blob => {
            saveImage({ recordId: this.recordId, imageBlob: blob })
                .then(() => {
